            ...
            <div class="row">
              ...
              <div class="col-6">
                ...
                <div class="input-group mb-3">
                  <input type="text" class="form-control" id="thn_ajaran" name="name_thn_ajaran"
                ...
                <td class="d-flex">
                  ...
                  <span>
                    <button type="button" class="btn btn-primary mt-2" data-coreui-toggle="modal"
                      data-coreui-target="#exampleModal{{ $th->id }}">
                      Edit
                    </button>
                  </span>
                  <div class="modal fade" id="exampleModal{{ $th->id }}" tabindex="-1"
                          ...
                          <form action="{{ route('edit.tahun_ajaran',['id'=>$th->id]) }}" method="POST">
                            ...
                            <div class="row">
                              <div class="col-12">
                                <label for="nama" class="form-label">Tahun Ajaran</label>
                                <input type="text" class="form-control" id="thn_ajaran" name="name_thn_ajaran"
                                  value="{{ $th->name_thn_ajaran }}" required
